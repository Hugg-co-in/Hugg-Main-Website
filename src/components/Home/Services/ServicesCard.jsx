...
const ServicesCard = ({ Icon, url, heading, para }) => {
  return (
    <div class="flex w-full h-full">
      <div class="text-center border border-solid border-[#ebebeb] py-[80px] px-[20px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-40  duration-300 hover:border-white hover:shadow-[0_0px_25px_0px_rgba(0,0,0,0.1)] w-full h-full">
